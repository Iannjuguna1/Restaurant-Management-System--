...
<head>
  ...
  <!-- animation -->
   <style>
    ...
    .swiper-slide {
        animation: slideAnimation 3s ease; /* custom animation with a duration of 3 seconds */
    }

    @keyframes slideAnimation {
        0% {
            transform: translateY(0); /* Initial position, s*/
        }
        100% {
...
<script>
   document.addEventListener("DOMContentLoaded", function () {
      var swiper = new Swiper(".hero-slider", {
         ...
         speed: 1200, // Set the animation speed (adjust as needed)
         preloadImages: false,
         lazy: true,
         slidesPerView: 1,
         pagination: {
